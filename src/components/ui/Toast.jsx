...
export function Toast({ message, onDismiss, duration = 3000 }) {
  ...
  return (
    <div
      className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[99999] flex items-center gap-3 bg-[#0f172a] text-white text-sm font-medium px-4 py-3 rounded-[10px] shadow-xl transition-all duration-300"
