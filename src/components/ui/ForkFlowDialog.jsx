...
export function ForkFlowDialog({ open, onOpenChange, sourceFlow, onConfirm }) {
  ...
  useEffect(() => {
    if (open && sourceFlow) {
      ...
      setVisibility(sourceFlow.visibility === "public" ? "public" : "private");
      setBusy(false);
    }
  }, [open, sourceFlow]);
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        showCloseButton
        className="flex max-h-[min(90vh,560px)] w-[calc(100vw-2rem)] max-w-md flex-col gap-0 overflow-hidden p-0 sm:w-full"
      >
        {/* ── Scrollable body ── */}
        <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain">
          ...
          <Separator className="mx-6 mt-4 w-auto" style={{ marginInline: "1.5rem" }} />
