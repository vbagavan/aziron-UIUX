...
export const HUB_DIALOG_CONTENT_BASE =
  "!flex min-h-0 w-full max-w-[calc(100%-2rem)] flex-col gap-0 overflow-hidden p-0";

export const HUB_DIALOG_CONTENT_MD = `${HUB_DIALOG_CONTENT_BASE} h-[min(92vh,calc(100dvh-2rem))] max-h-[min(92vh,calc(100dvh-2rem))] sm:max-w-2xl`;
