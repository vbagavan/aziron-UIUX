...
export function DatabaseAskTab({ detail, record, seedPrompt, onSeedPromptApplied, onOpenQueryStudio }) {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <SourceAskPromptBox
        ...
        loading={loading}
        ariaLabel="Ask about this database"
        footer={
          <div className="flex w-full flex-wrap items-center justify-between gap-2">
            <span className="text-xs text-muted-foreground">{KNOWLEDGE_TERMS.askAiSearchingDatabase}</span>
            {onOpenQueryStudio ? (
              <button
                type="button"
