...
export const INITIAL_AGENTS = [
  { id: 0,  name: "Customer Appreciation",   description: "Create branded appreciation cards, submit for team approval, and send to recipients—from one chat.",                        date: "23 Mar 2025", provider: "OpenAI",    model: "GPT-4.5",        status: "active",   lastRun: "2 min ago",   success: 98,  accessEnabled: true,  visibility: "public"  },
  { id: 1,  name: "CV Agent",                description: "Streamlines resume creation with smart suggestions and formatting to help you stand out in any application.",                date: "23 Mar 2025", provider: "OpenAI",    model: "GPT-4.5",        status: "active",   lastRun: "1h ago",      success: 94,  accessEnabled: true,  visibility: "public",  knowledgeHubs: [8], ragMode: true, vectorSearch: true, vaultLabels: [{ label: "OpenAI API Key", key: "OPENAI_API_KEY", marketplacePublished: true }, { label: "ATS webhook secret", key: "ATS_WEBHOOK_SECRET", marketplacePublished: false }] },
  ...
  { id: 5,  name: "Skill Tracker",           description: "Monitors your skill development progress and recommends tailored learning paths for continuous growth.",                     date: "20 Jun 2025", provider: "OpenAI",    model: "GPT-4.5",        status: "error",    lastRun: "2h ago",      success: 62,  accessEnabled: false, visibility: "private" },
  { id: 6,  name: "Networking Assistant",    description: "Helps you build and maintain professional connections on LinkedIn and other major platforms.",                               date: "30 Jul 2025", provider: "Anthropic", model: "Claude 3 Haiku", status: "idle",     lastRun: "2 days ago",  success: 89,  accessEnabled: false, visibility: "private" },
  { id: 7,  name: "Salary Insights",         description: "Provides data-driven salary benchmarks and effective negotiation strategies for your specific role.",                        date: "12 Aug 2025", provider: "OpenAI",    model: "GPT-4o",         status: "active",   lastRun: "15 min ago",  success: 100, accessEnabled: true,  visibility: "public"  },
  ...
  { id: 16, name: "Mentorship Match",        description: "Connects you with experienced mentors in your industry for personalized guidance and ongoing support.",                      date: "29 Apr 2026", provider: "Anthropic", model: "Claude 3.5",     status: "disabled", lastRun: "2 weeks ago", success: 72,  accessEnabled: false, visibility: "private" },
  { id: 17, name: "Industry News Alerts",    description: " ",                                                                                                                        date: "10 May 2026", provider: "OpenAI",    model: "GPT-4o mini",    status: "active",   lastRun: "10 min ago",  success: 100, accessEnabled: false, visibility: "private" },
  { id: 18, name: "Work-Life Balance Tracker", description: "Monitors your work patterns and suggests practical strategies for achieving a healthier balance.",                        date: "25 Jun 2026", provider: "Anthropic", model: "Claude 3 Haiku", status: "idle",     lastRun: "1 week ago",  success: 81,  accessEnabled: false, visibility: "private" },
  { id: 19, name: "Continuous Learning Hub", description: "Recommends and tracks online courses and certifications to support your ongoing professional development.",                  date: "15 Jul 2026", provider: "OpenAI",    model: "GPT-4o",         status: "idle",     lastRun: "3 days ago",  success: 88,  accessEnabled: false, visibility: "private" },
];
